...
Playbooks, inventories and config files used with Ansible to manage my small homelab.![homelab](img/homelab.jpg?raw=true | width=100) This is still ongoing project and currently I'm waiting for more equipment to expand my network.
