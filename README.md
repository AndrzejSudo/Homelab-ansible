...
Playbooks, inventories and config files used with Ansible to manage my small homelab.<img src="img/homelab.jpg" width="500"> This is still ongoing project and currently I'm waiting for more equipment to expand my network.
