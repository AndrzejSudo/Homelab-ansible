...
Playbooks, inventories and config files used with Ansible to manage my small homelab. ![homelab](img/homelab.jpg)<img src="img/homelab.jpg" width="100"> This is still ongoing project and currently I'm waiting for more equipment to expand my network.
